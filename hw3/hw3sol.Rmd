...
labevents_tble <- labevents_tble %>%
  ...
  rename(calcium = "itemid_50893", magnesium = "itemid_50960",
         potassium = "itemid_50971", chloride = "itemid_50902",
         sodium = "itemid_50983", creatinine = "itemid_50912",
         bicarbonate = "itemid_50882", glucose = "itemid_50931",
         hematocrit = "itemid_51221", wbc = "itemid_51301") %>%
  show_query() %>%
  print(width = Inf)
```
...
chartevents_tble <- chartevents_tble %>%
  ...
  group_by(subject_id) %>% 
	summarise_all(min) %>% 
  left_join(chartevents_tble, by = c("subject_id", "charttime")) %>% 
  select(-charttime) %>% 
  ungroup() %>% 
  pivot_wider(names_from = itemid, names_prefix = "itemid_",
              values_from = valuenum) %>% 
  rename(meanbp = 'itemid_220181', 
         sbp = 'itemid_220179', 
         temp = 'itemid_223761', 
         resp_rate= 'itemid_220210',
         heartrate = 'itemid_220045') %>%
  show_query() %>%
  print(width = Inf)
```
