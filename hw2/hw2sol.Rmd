...
```
***Using the `typeof` function, we can check the parsed data types of these three programs. All the three programs generate `list` as the data type.***
...
```{r}
icustays_tble <- as_tibble(read_csv("/mnt/mimiciv/1.0/icu/icustays.csv.gz"))
```
